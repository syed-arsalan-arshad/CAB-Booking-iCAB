<div class="container-fluid mt-5 mb-5" style="height:500px">
    <div class="row">
        <div class="col-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-stripped table-hover table-responsive">
                        ...
                        <tr><th>S.No</th><th>Name</th><th>Email Id</th><th>Mobile No</th><th>Travel Distance(KM)</th><th>Rate/KM</th><th>Sub-Total</th><th>Tax</th><th>Total</th><th>Failed Code</th><th>Failed Reason</th><th>Failed Description</th></tr>
                        <?php 
                        $i = 1;
                        foreach($rs as $d){ ?>
                        
                        <tr><td><?php echo $i; ?></td><td><?php echo $d->name; ?></td><td><?php echo $d->email; ?></td><td><?php echo $d->mobile; ?></td><td><?php echo $d->distance; ?></td><td><?php echo $d->rate; ?></td><td><?php echo $d->amount; ?></td><td><?php echo $d->tax; ?></td><td><?php echo $d->finalAmount; ?></td><td><?php echo $d->failedCode; ?></td><td><?php echo $d->failedReason; ?></td><td><?php echo $d->failedDescription; ?></td></tr>
